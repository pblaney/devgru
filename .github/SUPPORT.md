# Getting help with `devgru`

Thank you for using `devgru`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/devgru`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/devgru),
...
[search issues and pull requests](https://github.com/pblaney/devgru/issues)
