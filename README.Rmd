...
This release contains the snapshot of the code repository state when used in the Daytona release of the [`mgp1000`](https://github.com/pblaney/mgp1000).
...
See [this tutorial](https://bioconductor.org/help/course-materials/2015/Uruguay2015/V3-GenomicRanges.html) for a great fundamental breakdown of working with `GenomicRanges`
